...
var selectedCustDetails = {
    ...
    renderSelectedCustLoanList:function(len,res){
        ...
        console.log("Selected Agreement ID Performance "+loanItem.AgreementID);
		agreementID = loanItem.AgreementID;
...
/***************************************rendering the folio and arrears list************************************************/
		...
		ul.append('<li data-theme="d" class="ui-li-static ui-body-d" id="list0">\n\
						...
						<div>\n\
							<a href="#" class="lastTransaction" onclick=selectedCustLoanDetails.showTransactionHistory("'+prevFolioNo+'","'+term+'","'+agreementID+'","'+folioNo+'")>Last 13 weeks transactions</a>\n\
						</div>\n\
					</li>');
