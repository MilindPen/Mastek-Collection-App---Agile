...
function validatePin(){
  ...
  if(pinTotal.length != 4){
        ...
        validateNewUser.sendNewRegistrationToDatabase(verifiedUser.userId.toString(), verifiedUser.title, verifiedUser.firstName, verifiedUser.middleName, verifiedUser.lastName, macid, encryptedPass, isLocked);
