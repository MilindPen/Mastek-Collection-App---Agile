		...
		console.log(res);
		 ...
		 var paymentDate,paymentTime;
			 ...
			 if(listItem.PaidDate != "" && listItem.PaidDate != null && listItem.PaidDate != undefined){
				...
				if(even)
				$('tbody.transactionHistoryTable').append('<tr class=tr-highlighted id=row'+i+'><td class="payDateCol" id='+i+'>'+paymentDate+' '+paymentTime+'</td><td class="amtCol" id=td2'+i+' >'+Amount+'</td><td class=nopadding>'+amountCr+'</td><td class="arrearsCol" id=td3'+i+' >'+arrears+'</td><td class=nopadding>'+arrearsCr+'</td></tr>');
				else
				$('tbody.transactionHistoryTable').append('<tr id=row'+i+'><td class="payDateCol" id='+i+'>'+paymentDate+' '+paymentTime+'</td><td class="amtCol" id=td2'+i+' >'+Amount+'</td><td class=nopadding>'+amountCr+'</td><td class="arrearsCol" id=td3'+i+' >'+arrears+'</td><td class=nopadding>'+arrearsCr+'</td></tr>');
