...
@Entity
@Table(name = "[mobile].[vwAgreementList]")
public class VWAgreementList
{
	...
	/** The agreement number. */
	@Column(name = "ReloanedFromAgreementNumber")
	private String previousFolioNumber;
	
	@Column(name = "AAIndicatorID")
	private String aaIndicatorId;
